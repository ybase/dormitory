  ...
  <tr>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
    	<tr>
    		...
    		<th background="Admin/images/tab_14.gif" class="STYLE1">书号</th>
    		<th background="Admin/images/tab_14.gif" class="STYLE1">书名</th>
    	...
    	<c:forEach var="orderItem" items="${order.orderItem}">
    		<tr>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.orderId }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.orderItemId }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.bookId }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.bookName }</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.price}</td>
    			<td bgcolor="#FFFFFF" class="STYLE2">${orderItem.bookNum}</td>
    		</tr>
    	</c:forEach>
    </table>
    </td>
